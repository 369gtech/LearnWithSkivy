...
const Learning = () => {
  ...
  const accordionDataTwo = [
    { id: 'One', heading: 'Learn With Skivy 3.1 Common Sight Words "Three Letter Spelling Adventure', title: '"3.1 CSW "Three Letter Spelling Adventure"', description: "Press the green flag and then press Start Lesson. Listen to the word you need to spell, then move the blue letters onto the yellow circles to create the word.", src: 'https://scratch.mit.edu/projects/1023080937/embed' },
    { id: 'Two', heading: 'Learn With Skivy 3.1 Common Sight Words "Three Letter Spelling Quiz', title: '"3.1 CSW "Three Letter Spelling Quiz"', description: "Press the green flag and then press Start Lesson. Listen to quiz and choose the correct answer A, B or C to match the sentence that has been said and shown.", src: 'https://scratch.mit.edu/projects/1025386908/embed' },
    { id: 'Three', heading: 'Learn With Skivy 3.1 Common Sight Words "Three Letter Spelling', title: '"3.1 CSW "Three Letter Spelling"', description: "Press the green flag and then press Start Lesson to begin the spelling lesson.", src: 'https://scratch.mit.edu/projects/1024637441/embed' },
    ...
    { id: 'Five', heading: 'Learn With Skivy 3.2 Common Sight Words "Three Letter Spelling Quiz', title: '"3.2 CSW "Three Letter Spelling Quiz"', description: "Press the green flag and then press Start Lesson. Listen to quiz and choose the correct answer A, B or C to match the sentence that has been said and shown.", src: 'https://scratch.mit.edu/projects/1025636185/embed' },
    { id: 'Six', heading: 'Learn With Skivy 3.2 Common Sight Words "Three Letter Spelling', title: '"3.2 CSW "Three Letter Spelling"', description: "Press the green flag and then press Start Lesson to begin the spelling lesson.", src: 'https://scratch.mit.edu/projects/1025366126/embed' },
    ...
    { id: 'Eight', heading: 'Learn With Skivy 3.3 Common Sight Words "Three Letter Spelling Quiz', title: '"3.3 CSW "Three Letter Spelling Quiz"', description: "Press the green flag and then press Start Lesson. Listen to quiz and choose the correct answer A, B or C to match the sentence that has been said and shown.", src: 'https://scratch.mit.edu/projects/1026172923/embed' },
    { id: 'Nine', heading: 'Learn With Skivy 3.3 Common Sight Words "Three Letter Spelling', title: '"3.3 CSW "Three Letter Spelling"', description: "Press the green flag and then press Start Lesson to begin the spelling lesson.", src: 'https://scratch.mit.edu/projects/1025372666/embed' },
    { id: 'Ten', heading: 'Learn With Skivy "Three Letter Rhyming Words"', title: '"Three Letter Rhyming Words"', description: "Press the green flag and then press Start Lesson. Move the correct rhyming words into the green blocks and then press next to advance.", src: 'https://scratch.mit.edu/projects/1009757098/embed' },
    { id: 'Eleven', heading: 'Learn With Skivy Rhyming 1 "Three Letter Spelling Lesson"', title: 'Rhyming 1 "Three Letter Spelling Lesson"', description: "Press the green flag and then press Start Lesson to begin the spelling lesson.", src: 'https://scratch.mit.edu/projects/1018617643/embed' },
    { id: 'Twelve', heading: 'Learn With Skivy Rhyming 2 "Three Letter Spelling Lesson"', title: 'Rhyming 2 "Three Letter Spelling Lesson"', description: "Press the green flag and then press Start Lesson to begin the spelling lesson.", src: 'https://scratch.mit.edu/projects/1020239919/embed' },
    { id: 'Thirteen', heading: 'Learn With Skivy Rhyming 3 "Three Letter Spelling Lesson"', title: 'Rhyming 3 "Three Letter Spelling Lesson"', description: "Press the green flag and then press Start Lesson to begin the spelling lesson.", src: 'https://scratch.mit.edu/projects/1020274619/embed' },
