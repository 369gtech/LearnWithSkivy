...
const Learning = () => {
  ...
  const accordionDataThree = [
    ...
    { id: 'Fifteen', heading: 'LWS The Body "Spelling"', title: 'The Body "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'Eighteen', heading: 'LWS The Animal "Spelling"', title: 'The Animal "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'TwentyOne', heading: 'LWS Doing Word "Spelling"', title: 'Doing Word "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'TwentyFour', heading: 'LWS Describing Word "Spelling"', title: 'Describing Word "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'TwentySeven', heading: 'LWS Food "Spelling"', title: 'Food "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'Thirty', heading: 'LWS Nature "Spelling"', title: 'Nature "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'ThirtyThree', heading: 'LWS Things "Spelling"', title: 'Things "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    ...
    { id: 'ThirtySix', heading: 'LWS Feelings "Spelling"', title: 'Feelings "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    { id: 'ThirtySeven', heading: 'LWS Naming Words "Spelling Adventure"', title: 'Naming Words "Spelling Adventure"', description: "Press the green flag and then press Start Lesson. Listen to the word you need to spell then move the blue letters onto the yellow circles to spell the correct word.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    { id: 'ThirtyEight', heading: 'LWS Naming Words "Quiz"', title: 'Naming Words "Quiz"', description: "Press the green flag and then press Start Lesson. Listen to the question and press the correct answer A, B or C.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
    { id: 'ThirtyNine', heading: 'LWS Naming Words "Spelling"', title: 'Naming Words "Spelling"', description: "Coming Soon.", src: 'https://scratch.mit.edu/projects/1041055559/embed' },
